# 👋 Hi, I'm Sanjeet Kumar — Senior Android Developer 👨‍💻  

Hi, I'm **Sanjeet Kumar**, a **Senior Android Developer** passionate about building seamless, scalable, and user-friendly mobile applications.  
With 6+ years of experience in **Kotlin**, **Java**, and **modern Android frameworks**, I specialize in crafting robust, production-grade apps that balance performance, design, and architecture elegance.

---

## 📖 About Me  

- 💬 6+ years of experience in architecting and developing Android apps (Kotlin & Java)  
- 🧠 Strong in **MVVM**, **MVI**, **MVP**, and **Clean Architecture**  
- 🚀 Expert in **Jetpack Compose**, **XML UI**, **Coroutines**, and **Android SDK**  
- 🧩 Skilled in dependency management using **Dagger-Hilt** and **Koin**  
...
### **Togopool Pvt. Ltd.** — Android Developer  
📅 *March 2024 – Present | Gurugram, Haryana*  

Built and maintained robust Android apps in mobility, logistics, and enterprise domains with modular architectures and efficient networking.

#### 🚖 Secure Express Platform (Taxi Ecosystem — Customer & Driver)
- [Secure Express – Request a Ryde (Customer App)](https://play.google.com/store/apps/details?id=com.secureexpress.customer&hl=en_IN)  
- [Secure Express – Driver (Driver App)](https://play.google.com/store/apps/details?id=com.secureexpress.driver&hl=en_IN)  
- Designed **Uber-like ride booking system** with live location tracking using **Branch.io SDK**, smart deep linking, and secured trip flow.  
- Integrated **multi-payment gateways (Stripe, Razorpay, Paystack, PawaPay, DirectPay)** for cross-region support.  
- Reduced overall load time by **75%** with improved data caching and background sync.  

#### 🚌 Gala Bus Platform (Shuttle Service — Customer & Driver)
- [Gala Bus (Customer App)](https://play.google.com/store/search?q=gala%20shuttle&c=apps&hl=en_IN)  
- [Gala Bus Driver (Driver App)](https://play.google.com/store/apps/details?id=com.galabus.driver)  
- Implemented **monthly Shuttle Pass system** for one-way/round-trip routes — replacing daily ticket purchases.  
- Optimized real-time bus tracking and route management using **Branch.io** & **Google Maps**.  

#### ✈️ Emirates CAE Flight Training LLC (Corporate Taxi Platform)
- [ECFT Ride (Customer App)](https://play.google.com/store/apps/details?id=ecft.ride.customer)  
- [ECFT Operator (Driver App)](https://play.google.com/store/apps/details?id=com.ecft.operator)  
...
- **Orca Logistic Customer App**  
- **Orca Logistic Driver App**  
- Designed for **real-time parcel tracking**, **geo-fenced delivery routes**, and **multi-gateway payment integration** (Razorpay, Paystack).  

✅ **Achievements at Togopool:**
- Reduced APK size by **25%** using asset & library optimization analysis.  
- Delivered **5+ high-performance live apps** to Google Play within tight deadlines.  
- Ensured **secure payment transactions** & **real-time event analytics** with Firebase and SDK integrations.  
...
- Improved stability by modularizing feature dependencies and using Hilt-based architecture.  
...
**Frameworks & Libraries:** Jetpack Compose, Android SDK, Retrofit, OkHttp, Glide, Coroutines, Firebase  
...
- 📱 Published **10+ live apps** on **Google Play Store** across taxi, logistics, carpool, and POS domains.  
- 🔧 Focused on **code modularity, testability**, and **UI/UX performance tuning**.  
- 🧭 Passionate about solving real-world mobility & logistics challenges using Android technologies.  
- 🌱 Currently exploring **Kotlin Multiplatform** and **Compose Multiplatform** for scalable app ecosystems.  
